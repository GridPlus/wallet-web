...
const setIntegrationName = (value) =>
  setItem(INTEGRATION_NAME_STORAGE_KEY, value);
...
const STORAGE_KEY = "storedClient";

export const getStoredClient = () => getItem(STORAGE_KEY) || "";

export const setStoredClient = (storedClient: string | null) => {
  if (!storedClient) return;
  setItem(STORAGE_KEY, storedClient);
};

export const removeStoredClient = () => {
