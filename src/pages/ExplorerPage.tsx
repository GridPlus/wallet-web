import { AddressTagInput } from "@/components/AddressTagInput";
import { UpdateAddressTagsModal } from "@/components/UpdateAddressTagsModal";
...
export const ExplorerPage = () => {
  ...
  const getAddrs = () => {
    setIsLoading(true);
    console.log("fetching explorer addresses");
    fetchAddresses({
      startPath: getPath(),
